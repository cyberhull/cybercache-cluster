 ...
 */
#ifndef _ENGINE_SNAPPY_H
#define _ENGINE_SNAPPY_H
...
/**
 * Wrapper around LZ compressor by Google.
 */
class CompressorSnappy: public CompressorEngine {
