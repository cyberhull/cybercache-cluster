 ...
 * ----------------------------------------------------------------------------
 *
 * Implementation of the LZF compression engine.
 */
#ifndef _ENGINE_LZF_H
#define _ENGINE_LZF_H
...
/**
 * Wrapper around LZF compressor by Marc Alexander Lehmann
 */
class CompressorLzf: public CompressorEngine {
