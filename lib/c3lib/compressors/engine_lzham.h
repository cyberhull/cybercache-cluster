 ...
 * ----------------------------------------------------------------------------
 *
 * Implementation of the Lzham compression engine.
 */
#ifndef _ENGINE_LZHAM_H
#define _ENGINE_LZHAM_H
...
/**
 * Wrapper around Lzham compressor by Richard Geldreich, Jr.
 */
class CompressorLzham: public CompressorEngine {
