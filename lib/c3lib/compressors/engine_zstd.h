 ...
 * ----------------------------------------------------------------------------
 *
 * Implementation of the Zstd compression engine.
 */
#ifndef _ENGINE_ZSTD_H
#define _ENGINE_ZSTD_H
...
/**
 * Wrapper around Zstd compressor by Yann Collet (Facebook, Inc.)
 */
class CompressorZstd: public CompressorEngine {
