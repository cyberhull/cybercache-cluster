 ...
 * ----------------------------------------------------------------------------
 *
 * Implementation of the LZ4 compression engine.
 */
#ifndef _ENGINE_LZ4_H
#define _ENGINE_LZ4_H
...
/**
 * Wrapper around LZ4 compressor by Yann Collet
 */
class CompressorLz4: public CompressorEngine {
