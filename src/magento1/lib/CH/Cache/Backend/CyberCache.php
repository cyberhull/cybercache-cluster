 ...
 * ----------------------------------------------------------------------------
 *
 * Implementation of the default Magento 1 cache store based on CyberCache Cluster.
 */
 ...
 * used as both default / general purpose Magento 1 cache) using methods
 ...
 */
class CH_Cache_Backend_CyberCache extends Zend_Cache_Backend implements Zend_Cache_Backend_ExtendedInterface
{
    /**
     ...
     * Class constructor.
     *
     * The argument array comes from `<cache><backend_options>` section in `app/etc/local.xml`.
     *
